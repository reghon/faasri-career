...
import { updateMyManagementProfileSchema, managementProfileBodySchema, managementProfileParamsSchema } from "./management_profile.schemas";
...
router.get("/me", asyncHandler(managementProfileController.getMe));
router.put(
  "/me",
  validate({
    body: updateMyManagementProfileSchema,
  }),
  asyncHandler(managementProfileController.updateMe),
);
